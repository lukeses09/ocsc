          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../../maintenance/cust/cust.php"><i class="fa fa-circle-o"></i> Customer </a> </li>                
                ...
                <li><a href="../../maintenance/disc/disc.php"><i class="fa fa-circle-o"></i> Discounts </a></li>   
              </ul>
            </li>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="../../trans/rm/rm.php"><i class="fa fa-circle"></i> Daily Remmitance Report </a></li>
