                  ...
                  + ADD NEW RECORD</button> </a> -->
                      <div class="box-header with-border">
                       <div class="row">
                        ...
                        <h4 class="box-title">
                             <a href="#formModal" onclick="transferSave()" role="button" title="Add New Container" class="btn btn-lg " data-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"> <i class="ion-social-buffer"></i> Container Form </h4>
                                </div>          
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                                    ...
                                    <div class="col-xs-4" id="nameErDv"> 
                                      <label><font color="darkred">*</font>Container Name</label> <!-- Prod_Name -->
                                      <input type="text" class="form-control" id="name">
                                    </div>               

                                    <div class="col-xs-4" id="heightErDv"> 
                                      <label><font color="darkred">*</font>Height</label> <!-- Prod_Name -->
                                      <input type="text" class="form-control" id="height">
                                    </div>   

                                    <div class="col-xs-4" id="widthErDv"> 
                                      <label><font color="darkred">*</font>Width</label> <!-- Prod_Name -->
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  ...
                                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                                    ...
                                    <div class="col-xs-12" id="descErDv"> 
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  ...
                                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                                    ...
                                    <div class="col-xs-6" id="qtyErDv"> 
                                      <label><font color="darkred">*</font>Quantity</label> <!-- Prod_Name -->
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
              <div class="box box-solid">
                <div class="box-header">
                  <h3 class="box-title">Browse Containers</h3>
      ...
      console.log(s);
          oTable.fnClearTable();
            for(var i = 0; i < s.length; i++) 
            {
              ...
              oTable.fnAddData
              ([
                  s[i][0],s[i][1],comma(s[i][2]),s[i][3],s[i][4],s[i][5],s[i][6],
...
var dataString = 'name='+name+ '&height='+height+ '&width='+width+ '&desc='+desc+ '&rate='+rate+ '&qty='+qty;
...
function validate(){
  ...
  if($('#height').val()==''){
    err = 'true';
    $('#heightErDv').addClass('has-error');
  }
  else
    $('#heightErDv').removeClass('has-error');     

  if($('#width').val()==''){
    err = 'true';
    $('#widthErDv').addClass('has-error');
  }
  else
    $('#widthErDv').removeClass('has-error');     

  

  if($('#rate').val()=='' || $('#rate').val()<=0 || isNaN($('#rate').val())==true){
    err = 'true';
  ...
  if($('#qty').val()=='' || $('#qty').val()<=0 || isNaN($('#qty').val())==true){
    err = 'true';
    $('#qtyErDv').addClass('has-error');
  }
  else
    $('#qtyErDv').removeClass('has-error');   
