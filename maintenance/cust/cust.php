                  ...
                  + ADD NEW RECORD</button> </a> -->
                      <div class="box-header with-border">
                       <div class="row">
                        ...
                        <h4 class="box-title">
                             <a href="#formModal" onclick="transferSave()" role="button" title="Add New Customer" class="btn btn-lg " data-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"> <i class="ion-android-people"></i> Customer Form </h4>
                                </div>          
                                <div class="modal-body" >

<!-- ------------------------------------------------------------------------------------------- -->

                                  <div class="row" style="margin-bottom:10px"> <!-- ROW SELECT TYPE-->
                                    
                                    <div class="col-xs-4"> 
                                      <label> Type </label> <!-- Prod_Name -->
                                      <select class="form-control" id="type" onchange="addCompRow(this.value)">
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                                    ...
                                    <div class="col-xs-4" id="nameErDv"> 
                                      <label><font color="darkred">*</font>Name</label> <!-- Prod_Name -->
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  <div class="row" style="margin-bottom:5px; display:none" id="rowComp"> <!-- ROW 3-->

                                    <div class="col-xs-6" id="CPnameErDv"> 
                                      <label><font color="darkred">*</font>Contact Person</label> <!-- Prod_Name -->
                                      <input type="text" class="form-control" id="CPname">
                                    </div>                                        

                                    <div class="col-xs-6" id="CPphoneErDv"> 
                                      <label><font color="darkred">*</font>Contact Person's Mobile</label> <!-- Prod_Name -->
                                      <input type="text" class="form-control" id="CPphone" data-inputmask='"mask": "9999-999-9999"' data-mask>
                                    </div>    
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
              <div class="box box-solid">
                <div class="box-header">
                  <h3 class="box-title">Browse Customers</h3>
...
var dataString = 'type='+type+ '&name=' +name+ '&email=' +email+ '&tel=' +tel+ '&phone='+phone+ '&CPname='+CPname+ '&CPphone='+CPphone+ '&add='+add;  
...
function addCompRow(get)
{
  var type = get;
  if(type=='Individual')
    $('#rowComp').css('display','none');
  else if(type=='Company')
    $('#rowComp').css('display','block');  

  $('#CPname').val('');
  $('#CPphone').val('');
  $('#CPnameErDv').removeClass('has-error');
  $('#CPphoneErDv').removeClass('has-error');
}
...
function validate(){
  ...
  if($('#type').val()=='Company')
  {
    ...
    if($('#CPphone').val()==''){
      err = 'true';
      $('#CPphoneErDv').addClass('has-error');
    }
    else
      $('#CPphoneErDv').removeClass('has-error');         
  }  
