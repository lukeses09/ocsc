              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  <table id="jsontable" class="table table-condensed table-striped table-hover">
                    <thead>
                      <tr>
                        <th style="width:130px">Trail ID.</th>   
      ...
      console.log(s);
          oTable.fnClearTable();
            for(var i = 0; i < s.length; i++) 
            {
              ...
              else if(s[i][1]=='Transaction')
                statcol = "label label-success";       
              else if(s[i][1]=='Maintenance')
                statcol = "label label-primary"; 
              else if(s[i][1]=='Utilities')
                statcol = "label label-warning";                  
              oTable.fnAddData
              ([
                  '<text class="text-info">'+s[i][0]+'</text>','<span class="'+statcol+'">'+s[i][1]+'</span>',s[i][2],s[i][3],s[i][4],s[i][5],s[i][6],
              ],false);                   
              oTable.fnDraw();                 
            } // End For    
