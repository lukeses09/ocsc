                  ...
                  + ADD NEW RECORD</button> </a> -->
                      <div class="box-header with-border">
                       <div class="row">
                        ...
                        <h4 class="box-title">
                             <a href="#formModal" onclick="transferSave()" role="button" title="Add New Charge" class="btn btn-lg " data-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content" >
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"> <i class="ion-android-locate"></i> Charge Form </h4>
                                </div>          
...
<!-- ------------------------------------------------------------------------------------------- -->
                                  <div class="row" style="margin-bottom:5px"> <!-- ROW 1 -->
                                    ...
                                    <div class="col-xs-4" id="typeErDv"> 
                                      <label><font color="darkred">*</font>Charge Type</label> <!-- Prod_Name -->
                                    ...
                                    <div class="col-xs-4" id="measureErDv"> 
                                      <label><font color="darkred">*</font>Measurement Name</label> <!-- Prod_Name -->
                                      <input type="text" class="form-control input-lg" id="measure">
                                    </div>   

                                    <div class="col-xs-4" id="rateErDv"> 
          ...
          <div class="col-lg-12 col-sm-12 col-xs-12">
              <div class="box box-solid">
                <div class="box-header">
                  <h3 class="box-title">Browse Charges</h3>
...
var dataString = 'type='+type+ '&measure='+measure+ '&rate='+rate;
  ...
  else // WILL UPDATE
  {
    ...
    cache: false,
      success: function(html)
      {
        /* $("#display").after(html); */
        $('#formModal').modal('hide');
        $("#msgContent").html('UPDATED: '+measure+'');
        document.getElementById('msg').style.display="block";      
        load();
      } // END OF UPDATE
    });  
...
function validate(){
  ...
  if($('#measure').val()==''){
    err = 'true';
    $('#measureErDv').addClass('has-error');
  }
  else
    $('#measureErDv').removeClass('has-error');     
