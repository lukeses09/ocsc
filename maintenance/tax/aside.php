          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../cust/cust.php"><i class="fa fa-circle-o"></i> Customer </a> </li>                
                ...
                <li class="active"><a href="tax.php"><i class="fa fa-circle"></i> Taxes </a></li>  
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i>  Order Form</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>  Order Leg </a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#"><i class="fa fa-circle-o"></i> Local Backup</a></li>      
                <li><a href="utilities/user/user_account.php"><i class="fa fa-circle-o"></i> User Accounts</a></li>                                                                                                                                                                        
              </ul>
            </li>
            <?php } ?>
